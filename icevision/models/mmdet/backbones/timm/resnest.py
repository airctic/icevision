...
class ResNest14D(MMDetTimmBackbone):
...
@BACKBONES.register_module(force=True)
class ResNest26D(MMDetTimmBackbone):
    def __init__(self, pretrained=True, out_indices=(0, 1, 2, 3, 4), **kwargs):
        super().__init__(pretrained=pretrained, out_indices=out_indices, **kwargs)
...
@BACKBONES.register_module(force=True)
class ResNest50D(MMDetTimmBackbone):
    def __init__(self, pretrained=True, out_indices=(0, 1, 2, 3, 4), **kwargs):
        super().__init__(pretrained=pretrained, out_indices=out_indices, **kwargs)
...
@BACKBONES.register_module(force=True)
class ResNest50D_1S4x24D(MMDetTimmBackbone):
    def __init__(self, pretrained=True, out_indices=(0, 1, 2, 3, 4), **kwargs):
        super().__init__(pretrained=pretrained, out_indices=out_indices, **kwargs)
...
@BACKBONES.register_module(force=True)
class ResNest50D_4S2x40D(MMDetTimmBackbone):
    def __init__(self, pretrained=True, out_indices=(0, 1, 2, 3, 4), **kwargs):
        super().__init__(pretrained=pretrained, out_indices=out_indices, **kwargs)
...
@BACKBONES.register_module(force=True)
class ResNest101E(MMDetTimmBackbone):
    def __init__(self, pretrained=True, out_indices=(0, 1, 2, 3, 4), **kwargs):
        super().__init__(pretrained=pretrained, out_indices=out_indices, **kwargs)
...
@BACKBONES.register_module(force=True)
class ResNest200E(MMDetTimmBackbone):
    def __init__(self, pretrained=True, out_indices=(0, 1, 2, 3, 4), **kwargs):
        super().__init__(pretrained=pretrained, out_indices=out_indices, **kwargs)
...
@BACKBONES.register_module(force=True)
class ResNest269E(MMDetTimmBackbone):
    def __init__(self, pretrained=True, out_indices=(0, 1, 2, 3, 4), **kwargs):
        super().__init__(pretrained=pretrained, out_indices=out_indices, **kwargs)
