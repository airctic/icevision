...
MMDetSparseRCNNBackboneConfig = partial(MMDetBackboneConfig, model_name="sparse_rcnn")
...
sparse_rcnn_r50_fpn_1x = MMDetSparseRCNNBackboneConfig(
...
sparse_rcnn_r50_fpn_mstrain_480_800_3x = MMDetSparseRCNNBackboneConfig(
...
sparse_rcnn_r50_fpn_300_proposals_crop_mstrain_480_800_3x = MMDetSparseRCNNBackboneConfig(
...
sparse_rcnn_r101_fpn_mstrain_480_800_3x_coco = MMDetSparseRCNNBackboneConfig(
...
sparse_rcnn_r101_fpn_300_proposals_crop_mstrain_480_800_3x = MMDetSparseRCNNBackboneConfig(
    config_path=base_config_path
