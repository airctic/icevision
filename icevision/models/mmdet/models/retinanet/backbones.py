...
r50_caffe_fpn_1x = MMDetBackboneConfig(
    ...
    cfg_filepath="mmdet/configs/retinanet/retinanet_r50_caffe_fpn_1x_coco.py",
...
r50_fpn_1x = MMDetBackboneConfig(
    model_name="retinanet",
    cfg_filepath="mmdet/configs/_base_/models/retinanet_r50_fpn.py",
...
r50_fpn_2x = MMDetBackboneConfig(
    model_name="retinanet",
    cfg_filepath="mmdet/configs/retinanet/retinanet_r50_fpn_2x_coco.py",
    weights_url="http://download.openmmlab.com/mmdetection/v2.0/retinanet/retinanet_r50_fpn_1x_coco/retinanet_r50_fpn_1x_coco_20200130-c2398f9e.pth",
)

r101_caffe_fpn_1x = MMDetBackboneConfig(
    model_name="retinanet",
    cfg_filepath="mmdet/configs/retinanet/retinanet_r101_caffe_fpn_1x_coco.py",
...
r101_fpn_1x = MMDetBackboneConfig(
    model_name="retinanet",
    cfg_filepath="mmdet/configs/retinanet/retinanet_r101_fpn_1x_coco.py",
...
r101_fpn_2x = MMDetBackboneConfig(
    model_name="retinanet",
    cfg_filepath="mmdet/configs/retinanet/retinanet_r101_fpn_2x_coco.py",
...
x101_32x4d_fpn_1x = MMDetBackboneConfig(
    model_name="retinanet",
    cfg_filepath="mmdet/configs/retinanet/retinanet_x101_32x4d_fpn_1x_coco.py",
...
x101_32x4d_fpn_2x = MMDetBackboneConfig(
    model_name="retinanet",
    cfg_filepath="mmdet/configs/retinanet/retinanet_x101_32x4d_fpn_2x_coco.py",
...
x101_64x4d_fpn_1x = MMDetBackboneConfig(
    model_name="retinanet",
    cfg_filepath="mmdet/configs/retinanet/retinanet_x101_64x4d_fpn_1x_coco.py",
...
x101_64x4d_fpn_2x = MMDetBackboneConfig(
    model_name="retinanet",
    cfg_filepath="mmdet/configs/retinanet/retinanet_x101_64x4d_fpn_2x_coco.py",
