...
r50_caffe_fpn_1x = MMDetBackboneConfig(
    ...
    cfg_filepath="mmdet/configs/mask_rcnn/mask_rcnn_r50_caffe_fpn_1x_coco.py",
...
r50_fpn_1x = MMDetBackboneConfig(
    model_name="mask_rcnn",
    cfg_filepath="mmdet/configs/_base_/models/mask_rcnn_r50_fpn.py",
...
r50_fpn_2x = MMDetBackboneConfig(
    model_name="mask_rcnn",
    cfg_filepath="mmdet/configs/mask_rcnn/mask_rcnn_r50_fpn_2x_coco.py",
...
r101_caffe_fpn_1x = MMDetBackboneConfig(
    model_name="mask_rcnn",
    cfg_filepath="mmdet/configs/mask_rcnn/mask_rcnn_r101_caffe_fpn_1x_coco.py",
...
r101_fpn_1x = MMDetBackboneConfig(
    model_name="mask_rcnn",
    cfg_filepath="mmdet/configs/mask_rcnn/mask_rcnn_r101_fpn_1x_coco.py",
...
r101_fpn_2x = MMDetBackboneConfig(
    model_name="mask_rcnn",
    cfg_filepath="mmdet/configs/mask_rcnn/mask_rcnn_r101_fpn_2x_coco.py",
...
x101_32x4d_fpn_1x = MMDetBackboneConfig(
    model_name="mask_rcnn",
    cfg_filepath="mmdet/configs/mask_rcnn/mask_rcnn_x101_32x4d_fpn_1x_coco.py",
...
x101_32x4d_fpn_2x = MMDetBackboneConfig(
    model_name="mask_rcnn",
    cfg_filepath="mmdet/configs/mask_rcnn/mask_rcnn_x101_32x4d_fpn_2x_coco.py",
...
x101_64x4d_fpn_1x = MMDetBackboneConfig(
    model_name="mask_rcnn",
    cfg_filepath="mmdet/configs/mask_rcnn/mask_rcnn_x101_64x4d_fpn_1x_coco.py",
...
x101_64x4d_fpn_2x = MMDetBackboneConfig(
    model_name="mask_rcnn",
    cfg_filepath="mmdet/configs/mask_rcnn/mask_rcnn_x101_64x4d_fpn_2x_coco.py",
