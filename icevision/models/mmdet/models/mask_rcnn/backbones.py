...
resnet50_caffe_fpn_1x = MMDetBackboneConfig(
    ...
    cfg_url=mmdet_base_url / "configs/mask_rcnn/mask_rcnn_r50_caffe_fpn_1x_coco.py",
...
resnet50_fpn_1x = MMDetBackboneConfig(
    model_name="mask_rcnn",
    cfg_url=mmdet_base_url / "configs/mask_rcnn/mask_rcnn_r50_fpn_1x_coco.py",
...
resnet50_fpn_2x = MMDetBackboneConfig(
    model_name="mask_rcnn",
    cfg_url=mmdet_base_url / "configs/mask_rcnn/mask_rcnn_r50_fpn_2x_coco.py",
...
resnet101_caffe_fpn_1x = MMDetBackboneConfig(
    model_name="mask_rcnn",
    cfg_url=mmdet_base_url / "configs/mask_rcnn/mask_rcnn_r101_caffe_fpn_1x_coco.py",
...
resnet101_fpn_1x = MMDetBackboneConfig(
    model_name="mask_rcnn",
    cfg_url=mmdet_base_url / "configs/mask_rcnn/mask_rcnn_r101_fpn_1x_coco.py",
...
resnet101_fpn_2x = MMDetBackboneConfig(
    model_name="mask_rcnn",
    cfg_url=mmdet_base_url / "configs/mask_rcnn/mask_rcnn_r101_fpn_2x_coco.py",
...
resnext101_32x4d_fpn_1x = MMDetBackboneConfig(
    model_name="mask_rcnn",
    cfg_url=mmdet_base_url / "configs/mask_rcnn/mask_rcnn_x101_32x4d_fpn_1x_coco.py",
...
resnext101_32x4d_fpn_2x = MMDetBackboneConfig(
    model_name="mask_rcnn",
    cfg_url=mmdet_base_url / "configs/mask_rcnn/mask_rcnn_x101_32x4d_fpn_2x_coco.py",
...
resnext101_64x4d_fpn_1x = MMDetBackboneConfig(
    model_name="mask_rcnn",
    cfg_url=mmdet_base_url / "configs/mask_rcnn/mask_rcnn_x101_64x4d_fpn_1x_coco.py",
...
resnext101_64x4d_fpn_2x = MMDetBackboneConfig(
    model_name="mask_rcnn",
    cfg_url=mmdet_base_url / "configs/mask_rcnn/mask_rcnn_x101_64x4d_fpn_2x_coco.py",
