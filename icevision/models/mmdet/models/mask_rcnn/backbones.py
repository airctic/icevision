...
resnet50_fpn_1x = MMDetBackboneConfig(
    model_name="mask_rcnn",
    config_path=mmdet_configs_path / "configs/mask_rcnn/mask_rcnn_r50_fpn_1x_coco.py",
...
resnet50_fpn_2x = MMDetBackboneConfig(
    model_name="mask_rcnn",
    config_path=mmdet_configs_path / "configs/mask_rcnn/mask_rcnn_r50_fpn_2x_coco.py",
...
resnet101_fpn_1x = MMDetBackboneConfig(
    model_name="mask_rcnn",
    config_path=mmdet_configs_path / "configs/mask_rcnn/mask_rcnn_r101_fpn_1x_coco.py",
...
resnet101_fpn_2x = MMDetBackboneConfig(
    model_name="mask_rcnn",
    config_path=mmdet_configs_path / "configs/mask_rcnn/mask_rcnn_r101_fpn_2x_coco.py",
