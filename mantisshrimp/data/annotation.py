...
__all__ = ['RLE', 'Polygon', 'BBox', 'ImageInfo', 'Instance', 'Annotation', 'Record', 'AnnotationParser', 'ImageParser',
...
# Cell
def show_record(record, draw_bbox=False, id2cat=None, fontsize=18, ax=None):
