__all__ = ["train_albumentations_tfms_fridge", "valid_albumentations_tfms_fridge"]
...
def train_albumentations_tfms_fridge():
    """ Composes a Pipeline of Albumentations Transforms for Fridge Objects dataset at the train stage
    ...
    Examples::
        >>> train_tfms = train_albumentations_tfms_fridge(train=True)
...
def valid_albumentations_tfms_fridge():
    """ Composes a Pipeline of Albumentations Transforms for Fridge Objects dataset at the train stage
    ...
    Examples::
        >>> valid_tfms = valid_albumentations_tfms_fridge(train=false)
