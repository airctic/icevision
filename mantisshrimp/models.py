...
__all__ = ['Learner', 'maskrcnn', 'fasterrcnn', 'show_pred', 'show_preds']
...
def maskrcnn(n_class, h=256, pretrained=True, **kwargs):
...
def fasterrcnn(n_class, h=256, pretrained=True, **kwargs):
...
# Cell
@patch
def predict(self:Learner, ims=None, rs=None):
