...
<div class="termy">
```console
$ pip install mmcv-full=="1.3.12" -f https://download.openmmlab.com/mmcv/dist/CUDA_VERSION/TORCH_VERSION/index.html --upgrade
$ pip install mmdet
```
</div>
...
<div class="termy">
```console
$ pip install mmcv-full=="1.3.12" -f https://download.openmmlab.com/mmcv/dist/cpu/TORCH_VERSION/index.html --upgrade
$ pip install mmdet
```
</div>
