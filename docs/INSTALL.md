...
!!! info "Torch and CUDA version"  
    There is an easy way find out what version of torch and cuda is available in the active environment 
...
('1.10.0+cu102', '10.2')
```
This means your torch version is `1.10.0` and cuda is `10.2`.  
